...
representation_model = "representation name"
	...
	for ngr in arg_ngram_range:
		for mdf in arg_min_df:
			for nrm in arg_norm:
				...
				params_prop.write('id\tpulp_id\tfold\tmi\tmax_iter\tlimiar_conv\tweight_relations\tnetwork_relation\n')
								...
								for i in range(10):
									...
									for m in arg_m:
										...
										for l in arg_l:													
											...
											f = open(file_name, 'a')
											f.write("python3 PU-LP.py {} {} {} {} > logs/{}_{}-pulp.log\n". format(pulp_id, dir_params_pulp_format, input_matrix_w, pu_lp_output, exp_id, pulp_id))
											...
											for net in range(len(net_metadata)):
												...
												for mi in arg_mi:
													...
													prop_id = md5('{} {} {} {} {} {} {}'.format(pulp_id, fold, mi, arg_max_iter, agr_limiar_conv, net_metadata.weight_relations[net], network_relation).encode()).hexdigest()
						
													params_prop.write('{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n'.format(prop_id, pulp_id, fold, mi, arg_max_iter, agr_limiar_conv, net_metadata.weight_relations[net], network_relation))													
